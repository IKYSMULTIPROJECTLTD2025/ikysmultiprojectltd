...
import { registerUser } from "../utils/account/auth/register";
...
const Sign_Up =  ()  => {
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (registrationResponse.success) {
        ...
        const registeredUserData = registrationResponse.data;
        ...
        setLoginError(`Error registering user: ${registrationResponse.error }`);
      }
    } catch (error: any) {
  ...
  return (
    <div className='flex min-h-screen flex-col py-10 pt-15 font-bold bg-lime-500'>
      <div>
