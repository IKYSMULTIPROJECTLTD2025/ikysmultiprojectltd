           ...
           <div className=''>
              ...
              <div className='flex flex-row py-2 gap-1 mt-3 max-sm:mt-4  pl-1'>
                 ...
                 {isFollowing ? ( <button onClick={handleUnfollow}
                  className="flex flex-row bg-blue-950 max-sm:text-xs text-sm text-white px-2 h-7 max-sm:px-2 
                  ...
                  className="bg-blue-950 text-xs max-sm:px-2 text-white px-4 h-7 max-sm:h-6  rounded">
                  Follow </button> )}  
