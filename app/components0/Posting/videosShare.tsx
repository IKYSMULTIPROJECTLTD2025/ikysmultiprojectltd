...
import { getVideosByIdShare } from '@/app/utils/videos';
...
const ShareVideosDetails: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProductImages = async () => {
      ...
      try {
        //@ts-ignore
        const response: ImageResponse = await getVideosByIdShare(id);
...
export default ShareVideosDetails;
