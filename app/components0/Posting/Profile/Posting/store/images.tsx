...
//   return (
//     <div className='font-bold  w-full text-sm min-h-screen'>
//       {isLoading ? (
...
//           {currentProducts.length === 0 && 
//           <p className='flex justify-center lg:text-xl md:text-lg  h-screen max-md:text-lg text-blue-950'>
//             Be The First To Upload Product Here!
//           </p>
