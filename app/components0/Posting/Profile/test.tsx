  ...
  return (
    ...
    md:pt-10 max-md:pt-0  ">
       ...
       lg:w-3/6 xl:w-2/6">
        ...
        <div className="sm: border-2 border-blue-950  max-sm:m-3 ">
          <h1 className="flex justify-center text-2xl text-blue-950 font-bold pt-5 
          max-sm:text-lg">My profile </h1>
          <div className="flex justify-center relative">
            <div className="w-64 h-64 max-sm:w-80 max-sm:h-80 mt-5 border-2 border-orange-950 bg-orange-100 
            rounded-full  relative">
              ...
              {profileImage && (
                ...
                className="absolute bottom-2 right-10 hidden
