...
const Home4 = () => {
  ...
  return (
   ...
   <div className='flex justify-center font-bold w-full border-2 border-black  bg-lime-500'>
    
       <div className='flex flex-col w-full m-1 bg- border-2 border-black h-auto font-bold'>
